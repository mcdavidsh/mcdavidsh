...
if (!isset($_POST['senderEmail'])) {
    ...
    if (!leafMailChec($senderEmail)) $senderEmail = "";
}
...
print '<div class="container col-lg-6">
        ...
        <form name="form" id="form" method="POST" enctype="multipart/form-data" action="">
            ...
            <div class="row">
                ...
                <div class="form-group col-lg-12"><label for="bcc">CC</label><input type="text" class="form-control  input-sm " id="bcc" name="bcc" value="' . $bcc . '" /></div>
            </div>
            <div class="row">
...
if ($_POST['action'] == "send") {
    ...
    foreach ($maillist as $email) {
        ...
        if (!leafMailChec($email)) {
            ...
            $mail->addCC(leafClear($bcc, $email));
